    ...
    <div className="section" id="about">
        <div className="container">
            <div className="col-md-6" data-aos="fade-up">
                ...
                <p>I have built many apps on NodeJs, angular and react that are currently used in production. I’m passionate about learning, expanding my knowledge and building high quality software.</p>
